      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/auth/signup">
            <button 
              className="w-full sm:w-auto h-14 px-10 text-lg font-semibold bg-white text-slate-900 rounded-xl shadow-lg hover:bg-slate-100 hover:shadow-xl transition-all duration-200 inline-flex items-center justify-center"
            >
              Start Writing Free
